...
class GzipDisk(Disk):
    ...
    def fetch(self, mode, filename, value, read):
        ...
        return value
DataUnversionedPath = 'data-unversioned/part2/luna/'
# DataUnversionedPath = '/Volumes/Data/luna/'
DataPath = 'data/part2/luna/'
# DataPath = '/Volumes/Data/luna/'
def getCache(scope_str):
    return FanoutCache(DataUnversionedPath + 'cache/' + scope_str,
                       disk=GzipDisk,
                       shards=64,
                       timeout=1,
                       size_limit=3e11,
